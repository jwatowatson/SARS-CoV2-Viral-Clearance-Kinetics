...
par(las=1, cex.lab=1.3, cex.axis=1.3, mfrow=c(1,2))
...
par(las=1, cex.lab=1.5, cex.axis=1.5,mfrow=c(4,3))
...
par(las=1, cex.lab=1.5, cex.axis=1.5,mfrow=c(2,3))
# A0
plot(density(thetas_mod1$intercept), main=expression('A'[0]),
